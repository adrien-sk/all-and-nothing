...
public class XmlRootCommandTest {
	public static IEnumerable<object[]> TestData() {
		...
		yield return new object[] { new string[] { "-f", "./files/valid.xml" }, "Valid" };
		...
		yield return new object[] { new string[] { "<De<sign><Code>hello world</Code></De<sign>" }, "Invalid" };

		yield return new object[] { new string[] { "-f", "./files/invalid.xml" }, "Invalid" };
	}
